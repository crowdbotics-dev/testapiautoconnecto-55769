...
## Project Structure
    ...
    ├── testapiautoconnecto_55769  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_55769`
...
2. Clone this repo and `cd testapiautoconnecto_55769`
